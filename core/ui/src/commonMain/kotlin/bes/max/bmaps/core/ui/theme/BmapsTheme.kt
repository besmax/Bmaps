package bes.max.bmaps.core.ui.theme
...
import bmaps.core.ui.generated.resources.*
import org.jetbrains.compose.resources.Font

@Composable
fun BmapsTheme(darkTheme: Boolean, content: @Composable () -> Unit) {
...
private val BmapsDarkColors = darkColorScheme(
...
private val BmapsLightColors = BmapsDarkColors.copy(
